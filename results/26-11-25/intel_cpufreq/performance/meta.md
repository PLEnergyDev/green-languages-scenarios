...
bg_workload: ~
config:
    name: "intel_cpufreq driver/performance settings"
    tlp: |
    ...
    single_threaded_kernel_params: |
        GRUB_CMDLINE_LINUX="isolcpus=5 nohz_full=5 rcu_nocbs=5 workqueue.power_efficient=false"
    multi_threaded_kernel_params: |
        GRUB_CMDLINE_LINUX="workqueue.power_efficient=false"
scenarios:
